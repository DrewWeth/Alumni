...
class OrgsControllerTest < ActionController::TestCase
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post :create, org: { desc: @org.desc, est_date: @org.est_date, id: @org.id, name: @org.name, parent: @org.parent }
    end
  ...
  test "should update org" do
    patch :update, id: @org, org: { desc: @org.desc, est_date: @org.est_date, id: @org.id, name: @org.name, parent: @org.parent }
    assert_redirected_to org_path(assigns(:org))
  end
